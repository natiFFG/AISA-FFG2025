...
7. ¿Qué tecnología y sistema de gestión están utilizando actualmente en su sitio web? (Ej.: CMS, frameworks).
8. ¿Cuentan con servidores propios o tienen preferencia por servicios en la nube para el hosting de la aplicación?
9. ¿Existen restricciones o requisitos de seguridad específicos, especialmente para la gestión de pagos y datos personales?
...
13. ¿Cuentan con un sistema de gestión de datos para los donantes que pueda integrarse con la aplicación?
